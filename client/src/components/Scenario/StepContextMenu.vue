...
import {StepContextOptionMethods} from "@/api/stepContextOptionMethods.js";
...
export default {
  components: {ScenarioContextMenuButton, CloseButton, StepContextMenuButton},
  data() {
    return {
      optionMethods: new StepContextOptionMethods(),
      options: [],
      showDropdown: false,
    }
  },
