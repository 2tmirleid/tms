...
import {ScenarioCommentMethods} from "@/api/scenarioCommentMethods.js";
...
export default {
  ...
  data() {
    return {
      commentMethods: new ScenarioCommentMethods(),
      comments: [],
      localValue: '',
      userID: null,
    }
  ...
  methods: {
    ...
    async refreshComments() {
      try {
        const response = await this.commentMethods.getComments(this.scenarioID);
    ...
    async createComment() {
      try {
        ...
        await this.commentMethods.createComment(this.scenarioID, body);
        this.localValue = '';
